...
$(function () {
    ...
    circleSlider
        ...
        .owlCarousel({
            ...
            navText: [
                '<img src="' + basePath + '/web/assets/img/prev-dark.svg" alt="" width="50">',
                '<img src="' + basePath + '/web/assets/img/next-dark.svg" alt="" width="50">',
            ],
            responsive: {
                0: {
                    items: 1,
    ...
    homeSlider.owlCarousel({
        ...
        responsiveClass: true,
        navText: [
            '<img src="' + basePath + '/web/assets/img/prev.svg" alt="" width="50">',
            '<img src="' + basePath + '/web/assets/img/next.svg" alt="" width="50">',
        ],
        responsive: {
            0: {
                items: 1,
