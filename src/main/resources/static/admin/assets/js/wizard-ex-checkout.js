...
function() {
    ...
    var e = document.querySelector(".credit-card-mask")
      ...
      , i = document.querySelector("#add-purchase")
      , n = document.querySelector("#add-purchase-details")
      , e = (e && new Cleave(e,{
        creditCard: !0,
    ...
    if (null !== e) {
        var o = e.querySelector("#wizard-checkout-form")
          , i = o.querySelector("#add-purchase")
          , n = o.querySelector("#add-purchase-details")
