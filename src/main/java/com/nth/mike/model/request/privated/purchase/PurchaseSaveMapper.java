        ...
        try {
            ...
            for (PurchaseDetailRequest detailRequest : psr.getPurchaseDetail()) {
                ...
                if(productDetailService.findById(productDetailId)==null){
                    ...
                    productDetailError.setProductName(productService.findById(productDetailId.getProductId()).getName());
                    ...
                    productDetailError.setMaterialName(materialService.findById(productDetailId.getMaterialId()).getName());
